      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="relative w-32 h-32">
            {/* Hard Hat */}
            <div className="absolute top-0 left-4 w-24 h-12 bg-yellow-400 rounded-t-lg animate-bounce z-10">
              <div className="absolute top-2 left-4 w-16 h-4 bg-gray-700 rounded-md"></div>
            </div>
            {/* Face */}
            <div className="absolute bottom-0 left-4 w-24 h-24 bg-pink-200 rounded-full flex items-center justify-center">
